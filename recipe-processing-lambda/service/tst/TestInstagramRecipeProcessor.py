...
INSTAGRAM_URL = "https://www.instagram.com/reel/DOCTm9eE-D-/?igsh=MWJyY29ub3RuODZy"
MEDIA_LAMBDA_NAME = "RecipeStack-InstagramMediaProcessorA53B0897-Rm4Ha11JxEHQ"  # ← replace with your actual name
...
# -----------------------------
def build_processor():
    return InstagramRecipeProcessor(
        api_key="",
...
def test_full_pipeline():
    ...
    recipe = processor.process(INSTAGRAM_URL)
...
def test_lambda_function_error():
    ...
    try:
        processor.process(INSTAGRAM_URL)
